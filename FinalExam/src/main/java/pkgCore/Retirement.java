...
public class Retirement {
	...
	public double MonthlySavings() {
		...
		double pmt =  FinanceLib.pmt(dMonthlySSI, iYearsToWork, dRequiredIncome, dAnnualReturnRetired, true); // <-- this should be fixed to calculate the real pmt
		return pmt;
	}
	...
	public double TotalAmountToSave() {
		...
		double pv = FinanceLib.pv(dMonthlySSI, dAnnualReturnRetired, dRequiredIncome, iYearsRetired, true);
